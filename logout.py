...
def pilih_kendaraan():
    ...
    tk.Label(root, text="Pilih Jenis Kendaraan",fg="black", bg="lightblue").pack(pady=10)
    kendaraan_var = tk.StringVar(value="motor")

    tk.Radiobutton(root, text="Motor", variable=kendaraan_var, bg="lightblue", fg="black", value="motor").pack(anchor="w", padx=21)
    tk.Radiobutton(root, text="Mobil", variable=kendaraan_var,  bg="lightblue",fg="black", value="mobil").pack(anchor="w", padx=23)
...
def set_background(window):
    image_path = "motor.png"  # Ganti dengan nama file gambar Anda
