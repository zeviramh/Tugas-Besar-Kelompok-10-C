...
def kembali_ke_menu():
    ...
    tk.Label(root, text="Sistem Parkir", font=("Arial", 16), bg= "#FFACC5", fg= "black").pack(pady=10, padx=50)
    tk.Button(root, text="Kendaraan Masuk", command=kendaraan_masuk, bg= "#FFACC5", fg= "black").pack(pady=10, padx=50)
    tk.Button(root, text="Kendaraan Keluar", command=kendaraan_keluar, bg= "#FFACC5", fg= "black").pack(pady=10, padx=50)   
